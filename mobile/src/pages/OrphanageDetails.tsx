...
export default function OrphanageDetails() {
  const route = useRoute(); // Permite ter acesso ao parâmetro id do orfanato
  ...
  }, [id]) // Depende do id do orfanato ser enviado para se executado a requisição dos detalhes do orfanato
